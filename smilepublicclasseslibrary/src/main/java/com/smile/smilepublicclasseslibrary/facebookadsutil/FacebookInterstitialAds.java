...
public class FacebookInterstitialAds {
    ...
    public class ShowFacebookAdsAsyncTask_AlertDialog extends AsyncTask<Void, Integer, Void> {
        ...
        public ShowFacebookAdsAsyncTask_AlertDialog(final AppCompatActivity activity, final String messageString, final float fontSize, final int endPoint) {
        ...
        public ShowFacebookAdsAsyncTask_AlertDialog(final AppCompatActivity activity, final String messageString, final float fontSize, final int endPoint, final AfterDismissFunctionOfShowFacebookAds afterDismissFunction) {
            this.activity = activity;
            this.messageString = messageString;
            this.fontSize = fontSize;
            this.endPoint = endPoint;
    ...
    public class ShowFacebookAdsAsyncTask_DialogFragment extends AsyncTask<Void, Integer, Void> {
        ...
        public ShowFacebookAdsAsyncTask_DialogFragment(final AppCompatActivity activity, final String messageString, final float fontSize, final int endPoint) {
            this.activity = activity;
            this.messageString = messageString;
            this.fontSize = fontSize;
            this.endPoint = endPoint;
        ...
        public ShowFacebookAdsAsyncTask_DialogFragment(final AppCompatActivity activity, final String messageString, final float fontSize, final int endPoint, final AfterDismissFunctionOfShowFacebookAds afterDismissFunction) {
