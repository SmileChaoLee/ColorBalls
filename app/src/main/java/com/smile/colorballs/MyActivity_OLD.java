...
public class MyActivity_OLD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScreenUtl.getScreenSize(MyActivity_OLD.this,size);
        screenWidth = size.x;
        screenHeight = size.y;

        // following are for testing

        int statusBarHeight = ScreenUtl.getStatusBarHeight(MyActivity_OLD.this);
        int actionBarHeight = ScreenUtl.getActionBarHeight(MyActivity_OLD.this);
        ...
        undoButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                undoTheLast();
                AdBuddiz.showAd(MyActivity_OLD.this);   // added on 2017-11-11
            }
        });
    ...
    */
            ...
            if (gridData.getGameOver()) {
                ...
                final AlertDialogFragment mDialogFragment = new AlertDialogFragment(new AlertDialogFragment.DialogButtonListener() {
                    ...
                    public void button1OnClick(AlertDialogFragment dialogFragment) {
                        ...
                        AdBuddiz.showAd(MyActivity_OLD.this);
                ...
                if ((indexI >= 0) && (indexJ >= 0)) {
                    if (gridData.moveCellToCell(new Point(indexI, indexJ), new Point(i, j))) {
                        ...
                        */
                        ...
                        SoundUtl.playUhOhSound(MyActivity_OLD.this);
                        // SoundUtl.playTone();
                        // SoundUtl.playTone1();
                    }
                }
    ...
    private void recordScore(final int entryPoint) {
        final EditText et = new EditText(MyActivity_OLD.this);
        et.setTextSize(24);
        // et.setHeight(200);
        ...
        AlertDialog alertD = new AlertDialog.Builder(MyActivity_OLD.this).create();
    ...
    private class StartHistoryScore extends AsyncTask<Void,Integer,ArrayList<Pair<String, Integer>>> {
        ...
        protected void onPostExecute(ArrayList<Pair<String, Integer>> resultList) {
            ...
            AdBuddiz.showAd(MyActivity_OLD.this);   // added on 2017-10-24
        }
    }
